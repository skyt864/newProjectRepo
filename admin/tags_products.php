                ...
                $sql = "INSERT INTO tags_products(`Product Id`,`Tag id`)VALUES('$pid', '$tagid')" ;
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <?php echo $row['Tag id']; ?></a></td>
                        <!-- <td>Consectetur adipiscing</td>
                        <td>Donec tortor diam</td> -->
                        <td>
                            <!-- Icons -->
                <a href="categoriesedit.php?id=<?php// echo $row['category_id'] ?>"
                            title="Edit"><img 
