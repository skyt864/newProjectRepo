<?php
  ...
  if (!empty($_SESSION['cartProduct'])) {
    $total = count($_SESSION['cartProduct']);   
  }
                  ...
                  foreach ($_SESSION['cartProduct'] as $key => $value) {?>
                    <li>
                      ...
                      <a class="aa-cartbox-img" href="#"><img src="admin/productImage/<?php echo $value['image']; ?>" alt="img"></a>
                        <h4><a href="#"><?php $value['name']; ?></a></h4>
                        <p><?php echo  $value['qty']; ?> x $<?php echo $value['price'] ?></p>
                      <a class="aa-remove-product" href="header.php?delid=<?php echo $value['id']; ?>"><span class="fa fa-times"></span></a>
                      </div>
                    </li>
                    <?php $tPrice += $value['qty']*$value['price']; ?>
                  <?php } ?>
